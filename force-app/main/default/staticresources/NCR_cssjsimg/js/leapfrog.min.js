 ...
 */
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=a52e3ffbc4f502d3eb24)
 * Config saved to config.json and https://gist.github.com/a52e3ffbc4f502d3eb24
 */
 ...
 */
if(typeof jQuery==="undefined"){throw new Error("LeapFrog-Bootstrap-override's JavaScript requires jQuery")}+function(b){var a=b.fn.jquery.split(" ")[0].split(".");if((a[0]<2&&a[1]<9)||(a[0]==1&&a[1]==9&&a[2]<1)){throw new Error("LeapFrog-Bootstrap-override's JavaScript requires jQuery version 1.9.1 or higher")}if(console){console.log("::.. LeapFrog-Bootstrap-override's init ...")}}(jQuery);var initPopoverOverrides=function(){$.fn.popover.Constructor.DEFAULTS.template='<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-title"></h3><span aria-hidden="true" class="close popover-close" data-dismiss="popover" aria-label="Close" >&times;</span><div class="popover-content"></div></div>';$('[data-toggle="popover"]').popover({html:true});$("body").on("click",function(a){$('[data-toggle="popover"]').each(function(){if(!$(this).is(a.target)&&$(this).has(a.target).length===0&&$(".popover").has(a.target).length===0){$(this).popover("hide")}else{if(a.target.className==="close popover-close"){$(this).popover("hide")}}})})};$(document).ready(function(){initPopoverOverrides()});/*!
 * Leapfrog base JavaScript
 */
$(document).ready(function(){if(console){console.log("::.. Ready")}});
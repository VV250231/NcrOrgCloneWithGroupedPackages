...
import retrieveRecords from '@salesforce/apex/ReportScheduleController.retrieveRecords';
...
export default class customMultiSelectLookup extends LightningElement {
   ...
   @api  oppGlobalSelectedItems=[];
     ...
     @api setInitialItems(element){
  this.globalSelectedItems = element;
}
    ...
    handleCheckboxChange(event){
        ...
        const arrItems = this.selectedItems;
         ...
         const evtCustomEvent = new CustomEvent('select', { 
            detail: {arrItems}
            });

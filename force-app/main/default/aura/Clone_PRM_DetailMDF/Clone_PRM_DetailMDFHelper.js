            ...
            if (state === "SUCCESS") {
                ...
                {  
                    ...
                    if(allFileRows[indexVar].Claim__c)
                    {
                     ...
                     if(allFileRows[indexVar].Pre_Approval_Document_Type__c == 'Marketing Plan with Quarterly Milestones')
                    {
                        isMarketingPlanDoc = true;
                    }
                }
                cmp.set("v.isMarketingPlanAttachment", isMarketingPlanDoc);

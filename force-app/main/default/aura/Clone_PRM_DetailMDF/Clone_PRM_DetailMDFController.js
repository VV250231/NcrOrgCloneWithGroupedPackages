({
    ...
    detailMDFRequest : function(cmp, event, helper){
        var idParam = helper.getJsonFromUrl().mid;
        ...
        cmp.set("v.recId", idParam);
        helper.getMDFDetails(cmp, event, helper, idParam);
    },
    ...
    showMDFRequestModal : function(component, event, helper){
        //alert(component.get("v.isMarketingPlanAttachment"));
     /*   if(component.get("v.mdfRequest.Activity_Type__c") == 'NCR defined Sales Program – Funded Head Count Distributor Only' && 
           !component.get("v.isMarketingPlanAttachment"))
        {
           // alert("Please upload file");
             ...
             var toastEvent = $A.get("e.force:showToast");
                    toastEvent.setParams({  
                        "type": "info",
                        "message": "Marketing Plan with Quarterly Milestones attachment is required for \"NCR defined Sales Program – Funded Head Count Distributor Only\" Activity."
                    });
                    toastEvent.fire();

({
    ...
    isValidate : function(component, event, helper) {
        ...
        console.log("0 Accounttheater "+Accounttheater);
        ...
        if (typeof component.find("addTAM") === "undefined") {
            ...
            console.log("===Accounttheater ====",AccountRegion);
            if(addTAM =='--None--' && AccountRegion =='NAMER CFI' 
        ...
        if (selectedPI =='Financial'){
            ...
            //--simran if (!(oppValue || Monthly_Recurring_Rev))

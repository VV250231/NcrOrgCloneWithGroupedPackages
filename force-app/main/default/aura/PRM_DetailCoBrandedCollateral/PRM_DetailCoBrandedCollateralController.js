({
    ...
    getCoBranded : function(component, event, helper) {
        var action = component.get("c.getCoBrandedCollateralDetail");
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                component.set("v.objCoBranded", response.getReturnValue());
    ...
    openEdit : function(component, event, helper) {
        ...
        $A.get("e.force:navigateToURL").setParams({ 
            "url": "/edit-co-branded-collateral?coid=" + idParam
        }).fire();
    },

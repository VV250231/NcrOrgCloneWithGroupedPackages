({
	getMiscellaneousBusiness : function(component, event, helper) {
		var action = component.get("c.getMiscellaneousBusinessRelated");
    ...
    saveMiscellaneousBusinessController : function(component, event, helper) 
    {
        ...
        var action = component.get("c.updateMiscellaneousBusinessRelatedTopic");

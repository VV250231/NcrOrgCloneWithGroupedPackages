	...
	isValidate : function(component, event, helper)
    {
     ...
     /*   if(!component.find("Partner_Name").get("v.value"))
       ...
       if(!component.find("First_Name").get("v.value"))
        ...
        if(!component.find("Select_one_or_more_topics").get("v.value"))
        {
            component.find("Select_one_or_more_topics").set("v.errors",[{message:"Please Select one or more topics: "}]);
            submitREcord = false ;
        }
        else{
            component.find("Select_one_or_more_topics").set("v.errors",null);
        }

({
    ...
    doInit: function(component, event, helper){
        //alert('-----------'+component.get("v.mdfRequestId"));
        var action = component.get("c.getEditMDFDetail");
    ...
    removeDeletedRow: function(component, event, helper) {
        ...
        var listSize = AllRowsList.length;
       	var exp = AllRowsList[index];
        var RowItemList = component.get("v.deleteExpenses");
        if(exp.Id != undefined)
        {
        	RowItemList.push(exp.Id);
            component.set("v.deleteExpenses", RowItemList);
        }
        //alert(component.get("v.deleteExpenses"));
        if(listSize > 1)
        {
    ...
    cancelEditRequest: function(component, event, helper) {

({
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                */
                ...
                console.log("====Account Theater==== :"+ response.getReturnValue().accountTheater);
                ...
                component.find("selectAccountName").set("v.value", '--None--');
                console.log("Value from apex class : ",response.getReturnValue());
                // added by deeksharth
                ...
                if(response.getReturnValue().partnerIndustry.length == 1)
                {
                    ...
                    console.log("Value ListOfDependentFields : ",ListOfDependentFields);
    ...
    saveDealRegistrationController : function(component, event, helper) 
    {
            ...
            if (state === "SUCCESS") {
                ...
                if(helper.isValidate(component, event, helper))
                {
                    ...
                    action.setParams({ "objDR" : component.get("v.ObjDealRegistration"), 
                                      ...
                                      "servicingAccount": component.find("selectServicingAccount").get("v.value"),
                                     });
        ...
        //alert(component.find("selectAccountName").get("v.value") +"====" + component.find("selectPartnerContact").get("v.value"));    
    ...
    onControllerFieldChange: function(component, event, helper) {     
        ...
        {
            //Code added by deeksharth  for adding TAM 

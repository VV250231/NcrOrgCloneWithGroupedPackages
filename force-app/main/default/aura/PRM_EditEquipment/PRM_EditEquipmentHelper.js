({
    ...
    {        
        ...
        var action = component.get("c.getEquipmentDetailForEdit");
        action.setParams({
            'recId' : idParam
        });
        //set callback   
        ...
        action.setCallback(this, function(response) {
            if (response.getState() == "SUCCESS") 
            {
                ...
                if (Object.keys(StoreResponse).includes(controllerValueKey)==false)
                {  alert('This class is inactive please choose another class or contact with admin team');
                }
                ...
                if (controllerValueKey != '-- None --' || controllerValueKey != '' || controllerValueKey != null) 
                {
                    ...
                    if(ListOfDependentFields !=null && ListOfDependentFields!=undefined ){
                    ...
                    if(ListOfDependentFields2!=null && ListOfDependentFields2!=undefined)
                    {

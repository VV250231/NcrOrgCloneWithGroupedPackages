({
	isValidate : function(component, event, helper)
    {
       ...
       if(!component.find("First_Name").get("v.value"))
        ...
        if(!component.find("Success_Story").get("v.value"))
        {
            component.find("Success_Story").set("v.errors",[{message:"Please Enter Success Story: "}]);
            submitREcord = false ;
        }
        else{
            component.find("Success_Story").set("v.errors",null);
        }
        
        if(!component.find("Social_platform_to_share_NCR_Content").get("v.value"))
        {
            component.find("Social_platform_to_share_NCR_Content").set("v.errors",[{message:"Please Enter Social Media Post: "}]);
            submitREcord = false ;
        }
        else{
            component.find("Social_platform_to_share_NCR_Content").set("v.errors",null);
        }

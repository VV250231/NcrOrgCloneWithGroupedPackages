({
	savePartnerFeatureFridayController : function(component, event, helper) 
    {
        //alert(component.find("Partner_Name").get("v.value"));
		if(helper.isValidate(component, event, helper))
        {
			var action = component.get("c.savePartnerFeatureFriday");
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    component.set("v.partnerFeatureId", response.getReturnValue());

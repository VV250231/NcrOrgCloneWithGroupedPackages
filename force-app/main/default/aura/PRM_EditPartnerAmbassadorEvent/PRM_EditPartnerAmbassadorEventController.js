({
	...
	getPartnerEvent : function(component, event, helper) {
		var action = component.get("c.getPartnerAmbassadorEvent");
   	...
   	savePartnerAmbassadorEventController : function(component, event, helper) 
   	{
         if(helper.isValidate(component, event, helper))
       		{
        			var action = component.get("c.updatePartnerAmbassadorEvent");
